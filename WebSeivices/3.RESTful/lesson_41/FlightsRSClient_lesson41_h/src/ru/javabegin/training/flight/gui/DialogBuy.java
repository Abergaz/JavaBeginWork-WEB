...
import ru.javabegin.training.flight.object.ExtPlace;
 ...
 * @author Tim
 */
public class DialogBuy extends javax.swing.JDialog implements WSResultListener {

    private Flight flight;  // текущий выбранный рейс
    private final FlightRSClient flighRSClient; // ссылка на клиент веб сервиса

    /**
     * Creates new form DialogBuy
     */
    public DialogBuy(java.awt.Frame parent, boolean modal, FlightRSClient flighRSClient) {
        super(parent, modal);
        Registrator.getInstance().addListener(this, ListenerType.BUY_TICKET);
        this.flighRSClient = flighRSClient;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtFamilyName.setBackground(new java.awt.Color(255, 204, 204));

        txtDocumentNumber.setBackground(new java.awt.Color(255, 204, 204));
        ...
        comboPlaces.setBackground(new java.awt.Color(255, 204, 204));
    ...
    private void btnBuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuyActionPerformed
        ...
        // параметр для покупки билета
        TicketParam ticketParam = new TicketParam();
        ticketParam.setAddInfo(txtAddInfo.getText());
        ticketParam.setFlightId(flight.getId());
        ticketParam.setPassenger(passenger);
        ticketParam.setPlaceId(place.getId());
        
        // вызов веб сервиса по покупке билета        
        // Boolean.class - тип возвращаемого значения
        boolean result = flighRSClient.buyTicket(ticketParam, Boolean.class); 
