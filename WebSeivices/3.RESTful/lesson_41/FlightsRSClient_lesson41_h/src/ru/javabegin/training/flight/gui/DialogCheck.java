...
public class DialogCheck extends javax.swing.JDialog implements WSResultListener {
     ...
     */
    public DialogCheck(java.awt.Frame parent, boolean modal, FlightRSClient flighRSClient) {
        super(parent, modal);
        initComponents();
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        ...
        // вызов веб сервиса
        // ReservationResult.class - тип возвращаемого значения
        ReservationResult reservationResult = flighRSClient.checkReservationByCode(ReservationResult.class, txtCheckCode.getText());
        String message = null;
        
        Reservation reservation = reservationResult.getReservation();

        if (reservation != null) { // если найдена информация по бронированию
