 ...
 * 
 */
@WebServiceClient(name = "FlightWSService", targetNamespace = "http://ws.flight.training.javabegin.ru/", wsdlLocation = "http://localhost:8080/Flights_WS_lesson29/FlightWSService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Flights_WS_lesson29/FlightWSService?WSDL");
