...
public interface FlightWS {
     ...
     * @throws CityEmptyException_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    @Action(input = "http://javabegin.ru/training/ws/FlightWS/searchFlightRequest", output = "http://javabegin.ru/training/ws/FlightWS/searchFlightResponse", fault = {
        @FaultAction(className = CityEmptyException_Exception.class, value = "http://javabegin.ru/training/ws/FlightWS/searchFlight/Fault/CityEmptyException")
    })
