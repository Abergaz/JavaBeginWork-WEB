...
public interface FlightSEI{
    ...
    ArrayList<Flight> searchFlight(@WebParam(name = "date") long date, @WebParam(name = "cityFrom") City cityFrom, @WebParam(name = "cityTo") City cityTo) throws CityEmptyException;
