 ...
 * 
 */
@WebServiceClient(name = "FlightService", targetNamespace = "http://impls.interfaces.flight.training.javabegin.ru/", wsdlLocation = "http://localhost:8080/Flights_WS_lesson19/FlightService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName FLIGHTSERVICE_QNAME = new QName("http://impls.interfaces.flight.training.javabegin.ru/", "FlightService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Flights_WS_lesson19/FlightService?WSDL");
    ...
    public SearchImpl getSearchImplPort() {
        return super.getPort(new QName("http://impls.interfaces.flight.training.javabegin.ru/", "SearchImplPort"), SearchImpl.class);
    }
    ...
    public SearchImpl getSearchImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impls.interfaces.flight.training.javabegin.ru/", "SearchImplPort"), SearchImpl.class, features);
    }
