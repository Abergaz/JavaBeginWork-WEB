 ...
 * 
 */
@WebServiceClient(name = "SearchWS", targetNamespace = "http://ws.flight.training.javabegin.ru/", wsdlLocation = "http://localhost:8080/Flights_WS_lesson21/SearchWS?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Flights_WS_lesson21/SearchWS?WSDL");
