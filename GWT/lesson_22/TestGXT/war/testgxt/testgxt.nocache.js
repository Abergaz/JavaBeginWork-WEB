...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "testgxt" because\n';
  ...
  $wnd.__gwt_activeModules['testgxt'] = {
    'moduleName' : 'testgxt',
    'bindings' : function() {
      return {};
    }
 ...
 * "/testgxt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['testgxt'].superdevmode = true;

  var expectedSuffix = '/testgxt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + testgxt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:testgxt';
  var devModeSessionKey = '__gwtDevModeSession:testgxt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/testgxt/testgxt.nocache.js';
  ...
  $wnd.__gwt_activeModules['testgxt'].canRedirect = true;
  $wnd.__gwt_activeModules['testgxt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/testgxt?user.agent=' + ua + '&_callback=' + callback;
