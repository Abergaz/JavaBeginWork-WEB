...
<div class="book_list">
    ...
    <div class="book_info">
        <div class="book_title">
            <p> <a href="<%=request.getContextPath()%>/PdfContent?index=<%=list.indexOf(book)%>" target="_blank"><%=book.getName()%></a></p>
        </div>
        <div class="book_image">
            <a href="<%=request.getContextPath()%>/PdfContent?index=<%=list.indexOf(book)%>" target="_blank"><img src="<%=request.getContextPath()%>/ShowImage?index=<%=list.indexOf(book)%>" height="250" width="190" alt="Обложка"/></a>
        </div>
        <div class="book_details">
            ...
            <p style="margin:10px;"> <a href="<%=request.getContextPath()%>/PdfContent?index=<%=list.indexOf(book)%>" target="_blank">Читать</a></p>
        </div>
    </div>
